...
import { IAnime } from "@/type/Anime.ts";

type Props = {
	query: (
		data: QueryPagePerPage
	) => UseQueryHookResult<QueryDefinition<QueryPagePerPage, BaseQueryFn, never, AnimeSort>>;
	title: string;
	redirect: string;
};
			...
			<div className={"relative flex items-center"}>
				{isLoading ? (
					...
					<>
						...
						<div
							ref={sliderRef}
							className={"slider whitespace-nowrap overflow-x-scroll overflow-y-hidden scroll-smooth"}
						>
