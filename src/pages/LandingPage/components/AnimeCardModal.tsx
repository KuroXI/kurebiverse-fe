				...
				<div className={"absolute left-10 top-[30%]"}>
					...
					<div className={"flex flex-row gap-4 items-center"}>
						<Link to={`/watch/${data?.id}?episodeNumber=1`}>
							<button
								className={"text-black rounded-full bg-green-600 hover:bg-green-400 px-5 font-bold"}
							>
								<PlayArrow fontSize={"large"} />
							</button>
						</Link>
						<button
							className={"text-black rounded-full bg-neutral-600 hover:bg-neutral-400 px-5 font-bold"}
						>
							<Add fontSize={"large"} />
						</button>
					</div>
